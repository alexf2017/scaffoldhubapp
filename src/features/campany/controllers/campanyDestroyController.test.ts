...
describe('campanyDestroy', () => {
  ...
  it('must be signed in', async () => {
    try {
      await campanyDestroyManyController(
        {
          ids: [campany?.id],
        },
        await testContext(),
  ...
  it.skip('deletes', async () => {
    const countBeforeDelete = await prisma.campany.count();
    ...
    const countAfterDelete = await prisma.campany.count();
