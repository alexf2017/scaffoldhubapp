...
async function buildCampany(context: AppContext) {
...
describe('campanyCreate', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await campanyCreateController(body, await testContext());
      fail();
    } catch (error) {
