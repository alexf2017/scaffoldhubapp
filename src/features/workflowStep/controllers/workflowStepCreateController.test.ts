...
import { workflowStepCreateController } from 'src/features/workflowStep/controllers/workflowStepCreateController';
...
describe('workflowStepCreate', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await workflowStepCreateController(body, await testContext());
      fail();
    } catch (error) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await workflowStepCreateController(
        body,
        await testContext({
