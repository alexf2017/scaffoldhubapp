...
import { statusImporterController } from 'src/features/status/controllers/statusImporterController';
...
async function buildStatus(context: AppContext) {
...
describe('statusImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await statusImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it('must have permission', async () => {
    ...
    try {
      await statusImporterController(
        body,
        await testContext({
          currentUserId: currentUser?.id,
          currentTenantId: currentTenant?.id,
  ...
  it.skip('imports', async () => {
    ...
    const response = await statusImporterController(
