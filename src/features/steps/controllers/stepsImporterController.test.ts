...
async function buildSteps(context: AppContext) {
...
describe('stepsImport', () => {
  ...
  it('must be signed in', async () => {
    ...
    try {
      await stepsImporterController(body, await testContext());
      fail();
    } catch (error: any) {
  ...
  it.skip('imports', async () => {
    ...
    const response = await stepsImporterController(
