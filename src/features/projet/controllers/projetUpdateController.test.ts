...
import { projetUpdateController } from 'src/features/projet/controllers/projetUpdateController';
...
describe('projetUpdate', () => {
  ...
  //     const previousProjet = await createProjet(
  //       await testContext({
  //         currentUserId: currentUser?.id,
  //         currentTenantId: currentTenant?.id,
  //       }),
  ...
  //     const updatedProjet = await prisma.projet.findUniqueOrThrow({
  //       where: { id: previousProjet?.id },
  //       include: {},
  //     });
